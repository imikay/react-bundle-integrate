...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'limenius_react.react_renderer' => 'getLimeniusReact_ReactRendererService',
            'limenius_react.render_extension' => 'getLimeniusReact_RenderExtensionService',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ca5d240ffc157c65cc9e8c8450d5419ed5ccbeb6887d38f4d59de163c5566378');
    ...
    /**
     * Gets the 'limenius_react.react_renderer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Limenius\ReactBundle\Renderer\ReactRenderer A Limenius\ReactBundle\Renderer\ReactRenderer instance.
     */
    protected function getLimeniusReact_ReactRendererService()
    {
        return $this->services['limenius_react.react_renderer'] = new \Limenius\ReactBundle\Renderer\ReactRenderer($this->get('logger'), ($this->targetDirs[3].'/app/Resources/webpack/server-bundle.js'), false);
    }

    /**
     * Gets the 'limenius_react.render_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Limenius\ReactBundle\Twig\ReactRenderExtension A Limenius\ReactBundle\Twig\ReactRenderExtension instance.
     */
    protected function getLimeniusReact_RenderExtensionService()
    {
        return $this->services['limenius_react.render_extension'] = new \Limenius\ReactBundle\Twig\ReactRenderExtension($this->get('limenius_react.react_renderer'), 'both', true);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('limenius_react.render_extension'));
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('570e0d50adfe08.74609888')), true);
